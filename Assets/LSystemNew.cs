...
public class LSystemNew : MonoBehaviour {

    private List<LSystemNew> branches;
    private GameObject contents;
    private GameObject appearance;
    private LSystemNew lParent;
    ...
    void createChildren()
    {
        ...
        {
            LSystemNew child = new LSystemNew();
            branches.Add(child);
    ...
    public void construct(GameObject parentTree, float length, float radius)
    {
        ...
        appearance = GameObject.CreatePrimitive(LTreeController1.limbType);
        ...
        appearance.transform.Translate(0, 0.5f * LTreeController1.yScale * length, 0);
        createChildren();
    }
