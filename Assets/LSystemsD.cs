...
public class LSystemsD : MonoBehaviour {
	...
	public void CreateTree () {
        /*if (theTree != null) {
            //print("Thetree is null");
            Destroy(theTree.gameObject);
            //theTree = null;
            plant.Clear();
        }*/
        iter++;
        ...
        theTree.name = "Tree" + iter;
        foreach (GameObject go in plant) {
            go.transform.parent = theTree.transform;
        }
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	void CreateMesh(){
       ...
       // 	int splitCount = 
		...
		//	    print(j);
				...
				GameObject tmpPlant = new GameObject("Plane");
				MeshFilter filter = tmpPlant.AddComponent<MeshFilter>();
				...
				MeshRenderer renderer = tmpPlant.AddComponent(typeof(MeshRenderer)) as MeshRenderer;
            ...
            //New addition
            tmpPlant.name = "Branch else" + iter;
            plant.Add(tmpPlant);
        }
	}
    ...
    public void ClearLists() {
        ...
        iniPos3 = new List<Vector3>();


        iniPos = Vector3.zero;
        iniPos2 = Vector3.zero;
}
